...
const translations = {
  es: {
    ...
    'ticket.time': 'Hora:',
    'ticket.cashier': 'Cajero:',
    'ticket.unit_price': 'P.Unit',
    'ticket.payment': 'Pago:',
    'ticket.thanks': '¡Gracias por su visita!',
    'ticket.print_button': 'Imprimir Ticket',
    'Cantidad': 'Cantidad',
    'Producto': 'Producto',
  ...
  fr: {
    ...
    'ticket.title': 'TICKET DE CAISSE',
    'ticket.number': 'Ticket N° :',
    'ticket.time': 'Heure :',
    'ticket.cashier': 'Caissier :',
    'ticket.unit_price': 'P.Unit',
    'ticket.payment': 'Paiement :',
    'ticket.thanks': 'Merci de votre visite !',
    'ticket.print_button': 'Imprimer le Ticket',
    'Cantidad': 'Quantité',
    'Producto': 'Produit',
    ...
    'Actualizar': 'Actualiser',
    'Sesiones de Hoy': "Sessions d'Aujourd'hui",
    'Mostrando todas tus sesiones de caja del día actual': 'Affichage de toutes vos sessions de caisse du jour',
    'Cargando sesiones...': 'Chargement des sessions...',
    'No hay sesiones de caja para mostrar': 'Aucune session de caisse à afficher',
    'Fecha': 'Date',
    'Primera Apertura': 'Première Ouverture',
    ...
    'Acciones': 'Actions',
    'Tú': 'Vous',
    'Imprimir reporte diario': 'Imprimer le rapport journalier',
    'Registrar retiro de caja': 'Enregistrer un retrait de caisse',
    'Retiro': 'Retrait',
    ...
    'Registrar Retiro de Caja': 'Enregistrer un Retrait de Caisse',
    'Monto a retirar': 'Montant à retirar',
    'Motivo del retiro': 'Motif du retrait',
    'Seleccionar motivo': 'Sélectionner le motif',
    'Depósito bancario': 'Dépôt bancaire',
    'Pago a proveedor': 'Paiement fournisseur',
    'Gastos operativos': "Dépenses d'exploitation",
    'Cambio de billetes': 'Échange de billets',
    'Otros': 'Autres',
    'Notas adicionales': 'Notes additionnelles',
    'opcional': 'optionnel',
    'Detalles adicionales sobre el retiro...': 'Détails additionnels sur le retrait...',
    'Importante': 'Important',
    'Este retiro se restará del cálculo del cierre de caja esperado.': 'Ce retrait sera déduit du calcul de la fermeture de caisse prévue.',
    'Registrar Retiro': 'Enregistrer le Retrait',
    'Por favor completa todos los campos obligatorios': 'Veuillez remplir tous les champs obligatoires',
    'Retiro registrado exitosamente': 'Retrait enregistré avec succès',
    'Error al registrar el retiro': "Erreur lors de l'enregistrement du retrait",
