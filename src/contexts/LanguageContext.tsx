...
const translations = {
  es: {
    ...
    'Usar cierre esperado': 'Usar cierre esperado',
    ...
    'Mostrando ventas de': 'Mostrando ventas de',
    'Ventas Totales Camareros': 'Ventas Totales Camareros',
    'De': 'De',
    'A': 'A',
    ...
    // Economat
    'nav.economat': 'Economato',
    'economat.title': 'Economato',
    'economat.suppliers': 'Proveedores',
    'economat.items': 'Artículos',
    'economat.receipts': 'Entradas',
    'economat.issues': 'Salidas',
    'economat.losses': 'Mermas',
    'economat.stock_alerts': 'Alertas de Stock',
    'economat.expiration_alerts': 'Alertas de Caducidad',
    'economat.supplier_status': 'Estado de Proveedores',
    'economat.debit': 'Débito',
    'economat.credit': 'Crédito',

    // Ticket & Caisse translations

    'Historial de aperturas, cierres y resumen por camarero': 'Historial de aperturas, cierres y resumen por camarero',
    'Ventas por Camarero': 'Ventas por Camarero',
    'Balance': 'Balance',
    'Filtros': 'Filtros',
    'Resumen de Ventas por Camarero': 'Resumen de Ventas por Camarero',
    'Revise los pedidos de cada camarero e imprima su ticket individual de cierre': 'Revise los pedidos de cada camarero e imprima su ticket individual de cierre',
    'Cargando resumen de camareros...': 'Cargando resumen de camareros...',
    'No hay ventas registradas para los camareros': 'No hay ventas registradas para los camareros',
    'pedidos realizados': 'pedidos realizados',
    'cobrados': 'cobrados',
    'pendientes': 'pendientes',
    'Total Recaudado': 'Total Recaudado',
    'Imprimir ticket para ajustar cuentas con el camarero': 'Imprimir ticket para ajustar cuentas con el camarero',
    'Imprimir Ticket Camarero': 'Imprimir Ticket Camarero',
    'Ver detalle de pedidos': 'Ver detalle de pedidos',
    'Detalle de Pedidos de': 'Detalle de Pedidos de',
    'Sin pedidos registrados': 'Sin pedidos registrados',
    'Artículos del pedido': 'Artículos del pedido',
    'Cobrado': 'Cobrado',
    'Pendiente': 'Pendiente',
  ...
  fr: {
    ...
    // État de connexion
    'Buscar por nombre, categoría o precio...': 'Rechercher par nom, catégorie ou prix...',
    'Todas las categorías': 'Toutes les catégories',
    'Limpiar filtros': 'Effacer les filtres',
    'No se encontraron productos que coincidan con la búsqueda': 'Aucun produit ne correspond à la recherche',
    'productos': 'produits',
    'Available': 'Disponible',
    ...
    'Usar cierre esperado': 'Utiliser clôture prévue',
    'Día anterior': 'Jour précédent',
    'Día siguiente': 'Jour suivant',
    'Anterior': 'Précédent',
    'Siguiente': 'Suivant',
    'Hoy': 'Aujourd\'hui',
    'Ayer': 'Hier',
    'Por Día': 'Par Jour',
    'Rango de Fechas': 'Plage de Dates',
    'Mostrando ventas de': 'Affichage des ventes du',
    'Ventas Totales Camareros': 'Total Ventes Serveurs',
    'De': 'Du',
    'A': 'Au',
    ...
    // Backup Manager & Cash
    'Gestión de Backups': 'Gestion des Sauvegardes',
    'Backup Manual': 'Sauvegarde Manuelle',
    'Backup Automático': 'Sauvegarde Automatique',
    'Limpieza Selectiva': 'Nettoyage Sélectif',
    'Eliminar Seleccionados': 'Supprimer Sélectionnés',
    'Configuración de Empresa': 'Paramètres Entreprise',
    'Configuración de App': 'Paramètres Application',
    'Configuración de Backups': 'Configuration Sauvegardes',
    'Selecciona qué datos deseas eliminar permanentemente. Los datos no seleccionados se conservarán.': 'Sélectionnez les données à supprimer définitivement. Les données non sélectionnées seront conservées.',
    'Historial operativo eliminado correctamente.': 'Historique opérationnel supprimé avec succès.',
    'Datos eliminados correctamente': 'Données supprimées avec succès',
    'No se borraron datos. Verifica los permisos (RLS) en Supabase.': 'Aucune donnée supprimée. Vérifiez les permissions (RLS) dans Supabase.',
    'Gastos': 'Dépenses',
    'Registro de Tiempo': 'Suivi du Temps',
    'Ventas y Pedidos': 'Ventes et Commandes',
    'Gestión de Usuarios Eliminados': 'Gestion des Utilisateurs Supprimés',
    'Usuarios Eliminados': 'Utilisateurs Supprimés',
    'No hay usuarios eliminados en el sistema': 'Aucun utilisateur supprimé dans le système',
    'Eliminar Permanentemente': 'Supprimer Définitivement',
    'Esta acción no se puede deshacer': 'Cette action est irréversible',
    'Usuario eliminado permanentemente': 'Utilisateur supprimé définitivement',
    ...
    'Completar': 'Terminer',
    'Reimprimir Ticket': 'Réimprimer le Ticket',
    ...
    // Print Monitor
    'Auditoría de Impresión': 'Audit d\'Impression',
    'Monitor en tiempo real de todos los tickets enviados a las impresoras.': 'Surveillance en temps réel de tous les tickets envoyés aux imprimantes.',
    'Buscar por #pedido o cajero...': 'Rechercher par #commande ou caissier...',
    'Pedido:': 'Commande :',
    'Cajero:': 'Caissier :',
    'Ticket Pendiente': 'Ticket en Attente',
    'Ticket Final': 'Ticket Final',
    'Cargando historial de impresión...': 'Chargement de l\'historique d\'impression...',
    'Fecha/Hora': 'Date/Heure',
    'Pedido': 'Commande',
    'Trabajos de Impresión': 'Travaux d\'Impression',
    'Acciones': 'Actions',
    'No se encontraron resultados.': 'Aucun résultat trouvé.',
    'No hay trabajos de impresión registrados.': 'Aucun travail d\'impression enregistré.',
    'Caja': 'Caisse',
    'Cocina': 'Cuisine',
    'Reintentar': 'Réessayer',
    'Trabajo enviado a la cola nuevamente': 'Travail renvoyé dans la file d\'attente',
    'Error al reintentar': 'Erreur lors de la nouvelle tentative',
    'Completado': 'Terminé',
    'Fallido': 'Échoué',
    'Procesando': 'En traitement',
    'Enrutamiento de Comandas (QZ Tray)': 'Routage des Commandes (QZ Tray)',
    'Impresión silenciosa multi-zona': 'Impression silencieuse multi-zones',
    'IP del Servidor QZ Tray (Caja Central)': 'IP du Serveur QZ Tray (Caisse Centrale)',
    'Ej: 192.168.1.100 (dejar vacío para localhost)': 'Ex: 192.168.1.100 (laisser vide pour localhost)',
    'Escribe aquí la IP local del PC de Caja. Todos los dispositivos portátiles de los camareros se conectarán a esta IP para imprimir comanda sin configurar nada en sus móviles.': 'Écrivez ici l\'IP locale du PC de Caisse. Tous les appareils portables des serveurs se connecteront à cette IP pour imprimer sans rien configurer sur leurs mobiles.',
    'Conexión con QZ Tray': 'Connexion à QZ Tray',
    'Verifica que QZ Tray esté en ejecución en este equipo.': 'Vérifiez que QZ Tray est en cours d\'exécution sur cet ordinateur.',
    'Testear Conexión': 'Tester la Connexion',
    'Impresoras detectadas:': 'Imprimantes détectées :',
    'Copia exactamente el nombre de la impresora y pégalo en la "Zona de Impresión" de tus categorías.': 'Copiez exactement le nom de l\'imprimante et collez-le dans la "Zone d\'Impression" de vos catégories.',
    ...
    // Economat
    'nav.economat': 'Économat',
    'economat.title': 'Économat',
    'economat.suppliers': 'Fournisseurs',
    'economat.items': 'Articles',
    'economat.receipts': 'Bons de réception',
    ...
    'economat.supplier_status': 'État du Fournisseur',
    'economat.debit': 'Débit',
    'economat.credit': 'Crédit',

    // ── Sala (Salle) ──────────────────────────────────────────────────────
    'Mesas': 'Tables',
    'Error al cargar los pedidos': 'Erreur lors du chargement des commandes',
    'No hay pedidos en preparación.': "Aucune commande en préparation.",
    'Pedido validado': 'Commande validée',
    'Nuevo pedido': 'Nouvelle commande',
    'Ver Cuenta': 'Voir Compte',
    'Cobrar': 'Encaisser',

    // Ticket & Caisse translations (FR)

    'Historial de aperturas, cierres y resumen por camarero': 'Historique des ouvertures, fermetures et résumé par serveur',
    'Ventas por Camarero': 'Ventes par Serveur',
    'Balance': 'Solde',
    'Filtros': 'Filtres',
    'Resumen de Ventas por Camarero': 'Résumé des Ventes par Serveur',
    'Revise los pedidos de cada camarero e imprima su ticket individual de cierre': 'Consultez les commandes de chaque serveur et imprimez leur ticket individuel de clôture',
    'Cargando resumen de camareros...': 'Chargement du résumé des serveurs...',
    'No hay ventas registradas para los camareros': 'Aucune vente enregistrée pour les serveurs',
    'pedidos realizados': 'commandes effectuées',
    'cobrados': 'encaissées',
    'pendientes': 'en attente',
    'Total Recaudado': 'Total Collecté',
    'Imprimir ticket para ajustar cuentas con el camarero': 'Imprimer le ticket de règlement pour le serveur',
    'Imprimir Ticket Camarero': 'Imprimer Ticket Serveur',
    'Ver detalle de pedidos': 'Voir le détail des commandes',
    'Detalle de Pedidos de': 'Détail des Commandes de',
    'Sin pedidos registrados': 'Aucune commande enregistrée',
    'Artículos del pedido': 'Articles de la commande',
    'Cobrado': 'Encaissé',
    ...
    const loadLanguageFromDB = async () => {
      try {
        ...
        if (error) {
          ...
          console.log('⚠️ [LANGUAGE] Using default language: fr');
